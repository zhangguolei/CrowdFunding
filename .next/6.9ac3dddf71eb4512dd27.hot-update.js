...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__libs_projectList__ = __webpack_require__("./libs/projectList.js");
...
var _jsxFileName = "D:\\ethereum-contract-workflow\\ethereum-contract-workflow\\pages\\projects\\create.js";
...
function (_React$Component) {
  ...
  function ProjectCreate(props) {
    ...
    _this = _possibleConstructorReturn(this, (ProjectCreate.__proto__ || Object.getPrototypeOf(ProjectCreate)).call(this, props));
    _this.state = {
      description: '',
      minInvest: 0,
      maxInvest: 0,
    ...
    _this.onSubmit = _this.createProject.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(ProjectCreate, [{
    key: "getInputHandler",
    ...
    value: function () {
      ...
      __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee() {
        var _state, description, minInvest, maxInvest, goal, minInvestInWei, maxInvestInWei, goalInWei, accounts, owner, result;

        return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _state = this.state, description = _state.description, minInvest = _state.minInvest, maxInvest = _state.maxInvest, goal = _state.goal;
              ...
              case 12:
                minInvestInWei = __WEBPACK_IMPORTED_MODULE_4__libs_web3__["a" /* default */].utils.toWei(minInvest, 'ether');
                maxInvestInWei = __WEBPACK_IMPORTED_MODULE_4__libs_web3__["a" /* default */].utils.toWei(maxInvest, 'ether');
                goalInWei = __WEBPACK_IMPORTED_MODULE_4__libs_web3__["a" /* default */].utils.toWei(goal, 'ether');
                _context.prev = 15;
                this.setState({
                  loading: true,
                  errmsg: ''
              ...
              case 19:
                ...
                owner = accounts[0]; // 创建项目

                _context.next = 23;
                return __WEBPACK_IMPORTED_MODULE_5__libs_projectList__["a" /* default */].methods.createProject(description, minInvestInWei, maxInvestInWei, goalInWei).send({
                  from: owner,
                  gas: '5000000'
                });
              ...
              case 29:
                ...
                this.setState({
                  errmsg: _context.t0.message || _context.t0.toString
                });
    ...
    value: function render() {
      ...
      }, "\u521B\u5EFA\u9879\u76EE"), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__material_ui_core__["i" /* Paper */], {
        style: {
          width: '60%',
          padding: '15px',
          marginTop: '15px'
      ...
      }) : '创建项目'), !!this.state.errmsg && __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__material_ui_core__["q" /* Typography */], {
        component: "p",
        style: {
          color: 'red'
        },
...
/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_6__libs_withRoot__["a" /* default */])(ProjectCreate));
...
//# sourceMappingURL=6.9ac3dddf71eb4512dd27.hot-update.js.map